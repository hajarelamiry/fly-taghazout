          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="heroOutline" size="xl" asChild>
                <Link href="/activites">Explorer les vols</Link>
              </Button>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              ...
              <Button variant="default" size="lg" asChild>
                <Link href="/a-propos">En savoir plus <ArrowRight size={18} /></Link>
              </Button>
            </ScrollReveal>
              ...
              <ScrollReveal key={i} delay={i * 0.1}>
                <div className="h-full group bg-card rounded-2xl overflow-hidden shadow-luxury hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
                  ...
                  <div className="p-6">
                    ...
                    <Link href="/activites" className="text-primary text-sm font-semibold flex items-center gap-1 hover:gap-2 transition-all">
        ...
        <div className="container">
          ...
          <div className="text-center mt-12">
            <Button variant="outline" size="lg" asChild>
              <Link href="/a-propos">En savoir davantage <ArrowRight size={18} /></Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 lg:py-32">
        <div className="container">
          ...
          <div className="text-center mt-10">
            <Button variant="outline" size="lg" asChild>
              <Link href="/galerie">Voir la galerie complète <ArrowRight size={18} /></Link>
            </Button>
          </div>
        </div>
      </section>
